...
private:
    ...
    static constexpr double LeavingDistances[] = {
        ...
        // PARALLEL
        20.0*DISTANCE2PULSE,   // REVERSE_20
        25.0*DISTANCE2PULSE,   // FORWARD_20_STEER_LEFT
        5.0*DISTANCE2PULSE,    // CHANGE_WHEELS_RIGHT
        45.0*DISTANCE2PULSE,   // REVERSE_30_STEER_RIGHT
        15.0*DISTANCE2PULSE,   // TURN_RIGHT_2_LEFT 
        90.0*DISTANCE2PULSE,   // FORWARD_110_STEER_LEFT
        170.0*DISTANCE2PULSE   // FORWARD_110_STEER_RIGHT
    };
