...
private:
    ...
    static constexpr double ParkingDistances[] = {
        ...
        40.0,   // REVERSE_50CM_STEER_RIGHT_40
        0.0,    // STRAIGHTEN_WHEELS_STRAIGHT
        40.0,   // FINAL_REVERSE_80CM
        ...
        70.0*DISTANCE2PULSE,   // REVERSE_90CM
        0.0*DISTANCE2PULSE,    // STRAIGHTEN_WHEELS_PARALLEL
        60.0*DISTANCE2PULSE,   // REVERSE_20CM
        80.0*DISTANCE2PULSE,   // STEER_LEFT_100_REVERSE_1M
        10.0*DISTANCE2PULSE,   // STEER_RIGHT_100_REVERSE
        60.0*DISTANCE2PULSE,   // FORWARD_40CM
        15.0*DISTANCE2PULSE,   // STEER_LEFT_FINAL
        40.0*DISTANCE2PULSE,   // REVERSE_STRAIGHT_30
    };
