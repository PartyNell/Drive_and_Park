...
#define PARKING_SPACE_LIMIT_PARALLEL_LENGTH 80 //190
#define PARKING_SPACE_LIMIT_PARALLEL_DEPTH 60 //95
#define PARKING_SPACE_LIMIT_STRAIGHT_LENGTH 60 //140
#define PARKING_SPACE_LIMIT_STRAIGHT_DEPTH 80 //145
